###########################################################################
## Makefile generated for component 'BMSSOCEstimation'. 
## 
## Makefile     : BMSSOCEstimation.mk
## Generated on : Wed Feb 04 22:10:05 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMSSOCEstimation_msf.mexw64
...
MODELREF_LINK_RSPFILE     = BMSSOCEstimation_ref.rsp
COMPILER_COMMAND_FILE     = BMSSOCEstimation_comp.rsp
CMD_FILE                  = BMSSOCEstimation.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMSSOCEstimation_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=BMSSOCEstimation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_msf.c "$(MATLAB_ROOT)/extern/version/c_mexapi_version.c"
...
OBJS = BMSSOCEstimation_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work/slprj/sim/BMSSOC~1/BMSSOC~1.LIB
...
BMSSOCEstimation_msf.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
