...
## Generated on : Wed Feb 04 22:10:03 2026
## Final product: ./BMSSOCEstimationlib.lib
...
MODELLIB                  = BMSSOCEstimationlib.lib
...
PRODUCT = ./BMSSOCEstimationlib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation.c $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_capi.c
...
OBJS = BMSSOCEstimation.obj BMSSOCEstimation_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSSOCEstimation.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSSOCEstimation_capi.obj : $(START_DIR)/slprj/sim/BMSSOCEstimation/BMSSOCEstimation_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
