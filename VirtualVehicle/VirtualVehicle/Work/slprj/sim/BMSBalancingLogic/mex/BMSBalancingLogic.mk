###########################################################################
## Makefile generated for component 'BMSBalancingLogic'. 
## 
## Makefile     : BMSBalancingLogic.mk
## Generated on : Wed Feb 04 22:09:25 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMSBalancingLogic_msf.mexw64
...
PRODUCT_NAME              = BMSBalancingLogic
MAKEFILE                  = BMSBalancingLogic.mk
...
MODELREF_LINK_RSPFILE     = BMSBalancingLogic_ref.rsp
COMPILER_COMMAND_FILE     = BMSBalancingLogic_comp.rsp
CMD_FILE                  = BMSBalancingLogic.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMSBalancingLogic_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=BMSBalancingLogic -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic_msf.c "$(MATLAB_ROOT)/extern/version/c_mexapi_version.c"
...
OBJS = BMSBalancingLogic_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work/slprj/sim/BMSBAL~1/BMSBAL~1.LIB
...
BMSBalancingLogic_msf.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
