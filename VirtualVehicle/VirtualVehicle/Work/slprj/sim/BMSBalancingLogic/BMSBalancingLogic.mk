...
## Generated on : Wed Feb 04 22:09:23 2026
## Final product: ./BMSBalancingLogiclib.lib
...
MODELLIB                  = BMSBalancingLogiclib.lib
...
PRODUCT = ./BMSBalancingLogiclib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic.c $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic_capi.c
...
OBJS = BMSBalancingLogic.obj BMSBalancingLogic_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSBalancingLogic.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSBalancingLogic_capi.obj : $(START_DIR)/slprj/sim/BMSBalancingLogic/BMSBalancingLogic_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
