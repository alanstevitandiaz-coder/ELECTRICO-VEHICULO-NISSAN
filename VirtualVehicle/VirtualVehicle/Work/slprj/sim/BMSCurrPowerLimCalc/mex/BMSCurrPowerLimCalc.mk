###########################################################################
## Makefile generated for component 'BMSCurrPowerLimCalc'. 
## 
## Makefile     : BMSCurrPowerLimCalc.mk
## Generated on : Wed Feb 04 22:09:40 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMSCurrPowerLimCalc_msf.mexw64
...
PRODUCT_NAME              = BMSCurrPowerLimCalc
MAKEFILE                  = BMSCurrPowerLimCalc.mk
MATLAB_ROOT               = D:/Program Files/MATLAB/R2025b
MATLAB_BIN                = D:/Program Files/MATLAB/R2025b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = BMSCurrPowerLimCalc_ref.rsp
COMPILER_COMMAND_FILE     = BMSCurrPowerLimCalc_comp.rsp
CMD_FILE                  = BMSCurrPowerLimCalc.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMSCurrPowerLimCalc_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=BMSCurrPowerLimCalc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc_msf.c "$(MATLAB_ROOT)/extern/version/c_mexapi_version.c"
...
OBJS = BMSCurrPowerLimCalc_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work/slprj/sim/BMSCUR~1/BMSCUR~1.LIB
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"D:/Program Files/MATLAB/R2025b/extern/lib/win64/mingw64" -llibmwipp -llibfixedpoint -llibmwmathutil -llibmwsl_AsyncioQueue -lsf_runtime -llibmwslexec_simlog -llibmwcoder_ToAsyncQueueTgtAppSvc -llibmwsl_simtarget_instrumentation -llibmwsl_simtarget_core -llibmwstringutil -llibemlrt -llibmx -llibmex
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(LD) $(SHAREDLIB_LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) -Wl,--start-group @$(MODELREF_LINK_RSPFILE) $(call CONVERT_ESCAPED_SPACES_TO_QUOTES,$(LIBS)) -Wl,--end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
BMSCurrPowerLimCalc_msf.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


c_mexapi_version.obj : $(call ESCAPE_SPACES,$(MATLAB_ROOT))/extern/version/c_mexapi_version.c
	$(CC) $(CFLAGS) -o "$@" "$<"
