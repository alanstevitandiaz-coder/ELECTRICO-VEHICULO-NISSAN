...
## Generated on : Wed Feb 04 22:09:38 2026
## Final product: ./BMSCurrPowerLimCalclib.lib
...
MODELLIB                  = BMSCurrPowerLimCalclib.lib
...
PRODUCT = ./BMSCurrPowerLimCalclib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc.c $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc_capi.c
...
OBJS = BMSCurrPowerLimCalc.obj BMSCurrPowerLimCalc_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSCurrPowerLimCalc.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSCurrPowerLimCalc_capi.obj : $(START_DIR)/slprj/sim/BMSCurrPowerLimCalc/BMSCurrPowerLimCalc_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
