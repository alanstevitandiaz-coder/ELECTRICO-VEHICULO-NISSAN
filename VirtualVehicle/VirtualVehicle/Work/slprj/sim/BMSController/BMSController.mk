...
## Generated on : Wed Feb 04 22:12:02 2026
## Final product: ./BMSControllerlib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSController/BMSController.c $(START_DIR)/slprj/sim/BMSController/BMSController_capi.c
...
OBJS = BMSController.obj BMSController_capi.obj
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"D:/Program Files/MATLAB/R2025b/extern/lib/win64/mingw64" -llibmex -llibmwmathutil
...
%.obj : $(START_DIR)/slprj/sim/BMSController/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSController/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSController/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSController/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSController/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSController.obj : $(START_DIR)/slprj/sim/BMSController/BMSController.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSController_capi.obj : $(START_DIR)/slprj/sim/BMSController/BMSController_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
