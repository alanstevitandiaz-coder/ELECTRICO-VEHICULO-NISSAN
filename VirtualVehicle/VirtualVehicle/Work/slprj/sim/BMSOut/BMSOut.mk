...
## 
## Makefile     : BMSOut.mk
## Generated on : Wed Feb 04 22:09:51 2026
## Final product: ./BMSOutlib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSOut/BMSOut.c $(START_DIR)/slprj/sim/BMSOut/BMSOut_capi.c
...
OBJS = BMSOut.obj BMSOut_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/BMSOut/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSOut/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSOut/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSOut/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSOut/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSOut.obj : $(START_DIR)/slprj/sim/BMSOut/BMSOut.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSOut_capi.obj : $(START_DIR)/slprj/sim/BMSOut/BMSOut_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
