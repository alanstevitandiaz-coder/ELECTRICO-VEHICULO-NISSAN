###########################################################################
## Makefile generated for component 'BMSOut'. 
## 
## Makefile     : BMSOut.mk
## Generated on : Wed Feb 04 22:09:53 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMSOut_msf.mexw64
...
MODELREF_LINK_RSPFILE     = BMSOut_ref.rsp
COMPILER_COMMAND_FILE     = BMSOut_comp.rsp
CMD_FILE                  = BMSOut.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMSOut_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=BMSOut -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/BMSOut/BMSOut_msf.c "$(MATLAB_ROOT)/extern/version/c_mexapi_version.c"
...
OBJS = BMSOut_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work/slprj/sim/BMSOut/BMSOUT~1.LIB
...
BMSOut_msf.obj : $(START_DIR)/slprj/sim/BMSOut/BMSOut_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
