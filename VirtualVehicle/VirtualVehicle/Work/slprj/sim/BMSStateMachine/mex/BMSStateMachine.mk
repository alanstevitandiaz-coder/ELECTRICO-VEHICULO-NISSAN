###########################################################################
## Makefile generated for component 'BMSStateMachine'. 
## 
## Makefile     : BMSStateMachine.mk
## Generated on : Wed Feb 04 22:10:26 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BMSStateMachine_msf.mexw64
...
MODELREF_LINK_RSPFILE     = BMSStateMachine_ref.rsp
COMPILER_COMMAND_FILE     = BMSStateMachine_comp.rsp
CMD_FILE                  = BMSStateMachine.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BMSStateMachine_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=BMSStateMachine -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_msf.c "$(MATLAB_ROOT)/extern/version/c_mexapi_version.c"
...
OBJS = BMSStateMachine_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/pc/Desktop/JESUSH~1/VIRTUA~1/VIRTUA~1/Work/slprj/sim/BMSSTA~1/BMSSTA~1.LIB
...
BMSStateMachine_msf.obj : $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
