...
## Generated on : Wed Feb 04 22:10:24 2026
## Final product: ./BMSStateMachinelib.lib
...
MODELLIB                  = BMSStateMachinelib.lib
...
PRODUCT = ./BMSStateMachinelib.lib
...
SRCS = $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine.c $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_capi.c
...
OBJS = BMSStateMachine.obj BMSStateMachine_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/BMSStateMachine/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSStateMachine/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSStateMachine/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSStateMachine/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/BMSStateMachine/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BMSStateMachine.obj : $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BMSStateMachine_capi.obj : $(START_DIR)/slprj/sim/BMSStateMachine/BMSStateMachine_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
